...
@section('content')
<h2><b><center>Tambah Penjualan Menu</center></b></h2><br>
<form action="{{ route('penjualan_menus.store') }}" method="POST">
    @csrf
            <table class="table" id="menus_table">
                ...
                <tbody>
                    <tr id="menu0">
                        ...
                        @enderror
                        {{-- <td>
                            <input type="number" name="ratings[]" class="form-control rating-input"  min="0"/>
                        </td> --}}
            ...
            <div>
                ...
                <input type="number" class="form-control" id="total_bayar" name="total_bayar" min="0" style="width: 250px;">
            </div>
            <br>
            <div>
                <label for="kembalian"><strong>Kembalian:</strong></label>
                <span class="badge text-bg-danger" id="kembalian" style="font-size: 14px;">Rp.0</span>
            </div>
            <br>
            <div class="row">
                <div class="col-md-6">
